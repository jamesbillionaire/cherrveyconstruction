export const site = {
  ...
  tagline: "Built to deliver.",
  description: "CHERRVEY Construction Services delivers general construction, facility improvements and technical works for public and private projects in Mindanao.",
  foundedYear: 2021,
